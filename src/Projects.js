            ...
            <div class="flex overflow-x-scroll scrollbarhide overflow-y-hidden sm:mb-32">
                ...
                <div class="bg-customwhite flex-none w-96 h-120 mx-6 p-10 md:p-8 lg:p-10 ml-0 md:ml-32 lg:ml-70  relative">
                    ...
                    <div class="absolute bottom-0 w-full">
                        <h3 class="text-3xl headerfont ">TOOLS USED</h3>
                        <div class="grid grid-cols-2">
                            <h3 class="text-xl textfontthin">Python 3</h3>
                            <h3 class="text-xl textfontthin">Tensorflow</h3>
                            <h3 class="text-xl textfontthin">NLP/NLG</h3>
                            <h3 class="text-xl textfontthin">Restful APIs</h3>
                        </div>
                ...
                <div class="bg-customwhite flex-none w-96 h-120 mx-6 p-10 relative">
                    <h1 class=" text-5xl headerfont">BOM Radar</h1>
                    <h2 class="textfont">This was developped in order to allow easy posting of Lachlan's local rain radar into Slack channels by creating a gif from the images and serving this at a URL.</h2>
                    <div class="absolute bottom-0 w-full">
                        <h3 class="text-3xl headerfont">TOOLS USED</h3>
                        <div class="grid grid-cols-2">
                            <h3 class="text-xl textfont">Python 3</h3>
                            <h3 class="text-xl textfont">Serverless</h3>
                            <h3 class="text-xl textfont">AWS API Gateway</h3>
                            <h3 class="text-xl textfont">AWS Lambda</h3>
                        </div>
                        <div class="flex mt-4 h-8">
                ...
                <div class="bg-customwhite flex-none w-96 h-120 mx-6 p-10 relative">
                    <h1 class=" text-5xl headerfont">ENSO</h1>
                    <h2 class="textfont">This project is an iOS and Android app built in React Native as a response to Lachlan's growing frustration with OANDA's poorly designed version. This was designed in Adobe XD and implemented over the course of on and off weekends.</h2>
                    <div class="absolute bottom-0 w-full">
                        <h3 class="text-3xl headerfont">TOOLS USED</h3>
                        <div class="grid grid-cols-2">
                            <h3 class="text-xl textfont">React Native</h3>
                            <h3 class="text-xl textfont">AWS Amplify</h3>
                            <h3 class="text-xl textfont">iOS/Android</h3>
                            <h3 class="text-xl textfont">React Native</h3>
                        </div>
                        <div class="flex mt-4 h-8">
               ...
               <div class="bg-customwhite flex-none w-96 h-120 mx-6 p-10 relative">
                    <h1 class=" text-5xl headerfont">Daily NYT</h1>
                    <h2 class="textfont">This is an ongoing art piece whereby a 32" e-ink display automatically updates to showcase the latest New York Times front page. It's purpose is to allow a very non-invasive daily view of the world.</h2>
                    <div class="absolute bottom-0 w-full">
                        <h3 class="text-3xl headerfont">TOOLS USED</h3>
                        <div class="grid grid-cols-2">
                            <h3 class="text-xl textfont">Python 3</h3>
                 ...
                 {/* <div class="bg-customwhite flex-none w-96 h-120 mx-6 p-10 relative">
                    <h1 class=" text-5xl headerfont">NAME OF PROJECT</h1>
                    <h2 class="textfont">Desciption of Project goes here la la la la here's some lorem ipsum Lorem ipsum dolor sit amett goes here la la la la here's some lorem ipsum Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis interdum, metus vel suscipit elementum, leo justo fringilla arcu, id dictum libero est vel ante.</h2>
                    <div class="absolute bottom-0 w-full">
                        <h3 class="text-3xl headerfont">TOOLS USED</h3>
                        <div class="grid grid-cols-2">
                            <h3 class="text-xl textfont">Python</h3>
                            <h3 class="text-xl textfont">React</h3>
                            <h3 class="text-xl textfont">Tensorflow</h3>
                            <h3 class="text-xl textfont">React Native</h3>
                        </div>
                        <div class="flex mt-4 h-8">
                            <a class="mr-4" href="#project"><svg class="w-8 h-8 hover:fill-current hover:text-ironmanred" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>GitHub</title><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"/></svg></a>
                ...
                <div class="bg-customwhite flex-none w-96 h-120 mx-6 p-10 md:p-8 lg:p-10 mr-0 md:mr-32 lg:mr-70 relative">
                    ...
                    <div class="absolute bottom-0 w-full">
                        <h3 class="text-3xl headerfont">TOOLS USED</h3>
                        <div class="grid grid-cols-2">
                            <h3 class="text-xl textfont">HTML/CSS</h3>
                            <h3 class="text-xl textfont">React</h3>
                            <h3 class="text-xl textfont">Tailwind CSS</h3>
                            <h3 class="text-xl textfont invisible">EMPTY</h3>
                        </div>
                        <div class="flex mt-4 h-8">
