...
function Biography() {
  return (
    <div id="about" className="Biography" class="2xl:mx-80 xl:mx-60 lg:mx-40 mx-10 md:mt-24 mt-12 pt-12">
        <h2 class="text-black lg:text-9xl text-6xl w-full font-formula">BIOGRAPHY</h2>
        <div class="w-full md:grid md:grid-cols-5 md:grid-rows-1 md:auto-cols-min mt-10">
            <p class="md:col-start-4 md:col-span-2 md:row-start-1 text-left lg:ml-32 md:ml-16 md:my-auto text-base md:text-xl mb-10 font-tt-demibold">Engineer. Adventurer. Founder. Visionary. <br/> Lachlan Teale’s fanatical lifestyle is only matched by his abilities as a programmer.</p>
