...
const descriptions = {
  deloitte: {title: "Deloitte Australia", position: "Senior Consultant - AI", location: "Brisbane, Australia", description: (<p class="mt-10 mb-10 sm:text-xl description-text">I am a member of Deloitte's Artificial Strategic Growth Offering under the Consulting Division, where I am responsible for the development of a range of AI-powered assets. Working in a wide in a range of technologies, I am crucial in developing Digital Twin assets for clients in Mining, Agriculture, Professional Services and Manufacturing. These assets aim to bring the power of AI to both internal and external stakeholders and act as a catalyst for the development of new business models for the future.<br/><br/>Currently in progress are a wide arrange of projects touching:<br/><br/>- Discrete Event Simulations<br/>- Agent Based Simulations<br/>- Analytical Reporting/Insights Dashboard<br/>- Computer Vision</p>), start: "August 2021", end: "Present"},
  mater: {title: "Mater Pathology", position: "Business Analytics Lead", location: "Brisbane, Australia", description: (<p class="mt-10 mb-10 sm:text-xl description-text">I was tasked with proposing and developing a solution to an ongoing billing issue costing the company upwards of 6 figures annually. Utilising skills within software development, business management and data science, the solution utilised optical character recognition (OCR) in Python hosted on Cloud Infrastructure to allow for fast iteration, ease of use/development with limited APIs and resulted in a superior system than the manual processing previously employed within a team of 4 individuals.<br/><br/>I then proceeded to work on improving business processes utilising automation and exploratory data analysis focused on the commercial impact on the organisation.</p>), start: "March 2020", end: "August 2021"},
  athenix: {title: "Athenix", position: "Co-Founder", location: "Brisbane, Australia", description: (<p class="mt-10 mb-10 sm:text-xl description-text">Co-Founded and developed a solution to help customers make better decisions with their investments, through automation, proper risk management processes and backtesting on historical data, all without the need to code.<br/><br/>A member of the Suncorp Digital Labs Incubator 2.0 whereby we’re focused on customer testing, UX/UI design and ensuring our product market fit.</p>), start: "September 2019", end: "February 2020"},
  petra: {title: "PETRA Data Science", position: "Data Scientist", location: "Brisbane, Australia", description: (<p class="mt-10 mb-10 sm:text-xl description-text">I was tasked with designing solutions for problems faced by large, multinational mining companies. Working on tasks such as preventative maintenance, computer vision and optimisation, I utilised machine learning and statistical models written in python to further their business and create new opportunities and value for each client.</p>), start: "August 2018", end: "September 2019"},
  sitesee: {title: "SiteSee", position: "Machine Learning Engineer", location: "Brisbane, Australia", description: (<p class="mt-10 mb-10 sm:text-xl description-text">I maintained a package that allows for semantic segmentation of antenna tower scenes utilising U-Net (fully connected CNN with transposed convolution) and ResNet (Dilated Convolution with Bilinear Interpolation and Conditional Random Field). Implementations being in Tensorflow.<br/><br/>Alongside this, I converted the existing machine learning package to utilise an Xception network (an intermediate step in-between regular convolution and the depth-wise separable convolution operation) in an Encoder-Decoder structure.<br/><br/>These packages were being used for a number of large infrastructure clients such as oil and gas, telecommunications and energy related assets.</p>), start: "February 2018", end: "August 2018"}
}
            ...
            <div class="px-16 py-16">
              ...
              <div class="sm:grid sm:grid-cols-2 sm:grid-rows-1">
                <div class="sm:col-start-1 sm:row-start-1">
                  ...
                  <h2 class="text-4xl 2xl:text-6xl font-semibold mt-6 text-ironmanred">{descriptions[i].title}</h2>
                </div>
                <div class="sm:col-start-2 sm:row-start-1 mb-2 mt-10 sm:mt-auto">
                  <h3 class="text-base 2xl:text-2xl sm:text-right">{descriptions[i].location}</h3>
                  <h3 class="text-base 2xl:text-2xl sm:text-right flex sm:justify-end"><span class="text-ironmanred">{descriptions[i].start}</span> <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 mx-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg> {descriptions[i].end}</h3>
                </div>
              </div>
